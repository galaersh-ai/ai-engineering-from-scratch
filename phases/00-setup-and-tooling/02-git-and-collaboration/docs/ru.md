...
> Контроль версий — не опция. Каждый эксперимент, каждая модель, каждый урок, который ты здесь создашь, отслеживается.
...
- Настроить git-идентификатор и освоить ежедневный рабочий процесс: add, commit, push
...
- Навигировать по истории коммитов с `git log`, чтобы понимать эволюцию проекта
...
1. Сохраняйся часто (`git commit`)
2. Отправляй в remote (`git push`)
...
1. Склонируй этот репозиторий, создай ветку `my-progress`, сделай файл, закоммить, запушь
